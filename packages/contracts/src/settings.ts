...
export const PiSettings = Schema.Struct({
  ...
  sdkRoot: TrimmedString.pipe(Schema.withDecodingDefault(Effect.succeed(""))),
  agentDir: TrimmedString.pipe(Schema.withDecodingDefault(Effect.succeed(""))),
  useGlobalAgentDir: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
  customModels: Schema.Array(Schema.String).pipe(Schema.withDecodingDefault(Effect.succeed([]))),
});
...
const PiSettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(Schema.String),
  sdkRoot: Schema.optionalKey(Schema.String),
  agentDir: Schema.optionalKey(Schema.String),
  useGlobalAgentDir: Schema.optionalKey(Schema.Boolean),
  customModels: Schema.optionalKey(Schema.Array(Schema.String)),
});
